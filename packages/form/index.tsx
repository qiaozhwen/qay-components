...
export const FormCmp:React.ForwardRefRenderFunction<any, FormProps> = ({children, ...props}:FormProps, ref)=>{
  return <OriginalForm
    ref={ref}
    {...props}
  >
...
const FormForwardRef = React.forwardRef<any, FormProps>(FormCmp) as <Values = any>(props: FormInterface & {
